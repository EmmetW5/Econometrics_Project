...
and although restrictions on mass gatherings and school closures did not have a significant impact on the percentage change in new house listings, the did on the percentage change in overall inventory.
...
results %>%
  ...
  kable(format = "markdown", caption = "a")
```
...
Mohamed - write about census findings
