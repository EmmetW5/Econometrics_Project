...
Finally, we control using the houses under construction index instead, which only accounts for construction costs, and contrast with the price controlled by houses sold index. Both variables appear near-identical, indicating construction costs as the main driver of the effect we see.
```{r}
